...
class HookInternalTests: XCTestCase {
    ...
    func testHookObject() {
        ...
        XCTAssertFalse(try testIsSwiftHookDynamicClass(object: object))
        let superObject = SuperObject()
        XCTAssertFalse(try testIsSwiftHookDynamicClass(object: superObject))
        let selector = #selector(SuperObject.superFunc(arg:))
        do {
            ...
            XCTAssertTrue(try testIsSwiftHookDynamicClass(object: superObject))
